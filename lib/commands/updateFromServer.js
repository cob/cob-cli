        ...
        if (args.code) {
            ...
            for (const customization of customizations) {
                ...
                if (customization.definitions) {
                    ...
                    await getDefinitionsFromServer(cmdEnv.servername, customization.definitions.filter, definitionPath, viewsPath, customization.name, customization.definitions.user)
                }
