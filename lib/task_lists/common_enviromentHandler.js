...
async function getCurrentCommandEnviroment(args, newServername) {
    ...
    // On init (newServername) nothing was deployed yet, so there is no lastDeployEnv to read
...
function _validateServername(servername) {
    ...
    msg += "Use only the server name, without the " + "server_".bold + " prefix and without the domain"
