...
function executeTasks(cmdEnv, args) {
    ...
    return new Listr([
        ...
        {title: "Apply enviroment specifics",                 task: () => cmdEnv.applyCurrentCommandEnvironmentChanges() },        
        ...
        {title: "Undo enviroment specifics",                  task: () => cmdEnv.unApplyCurrentCommandEnvironmentChanges() },        
    ], {
