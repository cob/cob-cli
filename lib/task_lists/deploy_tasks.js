...
function deployTasks(server, args) { //TODO: options: staging OR production
    ...
    return new Listr([
        ...
        // checkout branch de novo
        // confirmar que os testes foram feitos
        // indicar alterações (commits) e sugerir um git rebase -n x para criar um único commit no master com a descrição da funcionalidade a fazer deploy
        // se sim fazer git rebase
