...
function newProjectTasks(env, projectName, repo, args) {
    return new Listr([
            ...
            {   title: "Get initial defaults",                         enabled: () => !args.legacy, task: () => copyFiles(env,"serverInitial","localCopy")                                   },
            ...
            {   title: "Get current config",                                                        task: () => copyFiles(env,"serverLive","localCopy")                                      },
            ...
            {   title: "Register release",                                                          task: () => registerRelease(env)                                                         },
