...
async function validateTestingConditions(cmdEnv, args) {
    ...
    let result = await new Listr([
            ...
            {   title: "Apply enviroment specifics".bold,       skip: ctx => !ctx.lastSha, task: ()     => cmdEnv.applySpecific() },
            ...
            {   title: "Undo enviroment specifics".bold,        skip: ctx => !ctx.lastSha, task: ()     => cmdEnv.undoSpecific() },
