...
function validateTestingConditions(server, args) {
    ...
    return new Listr([
        ...
        {   title: "Check there's no other 'cob-cli test' running locally".bold,       task: ()     => checkNoTestsRunningLocally() }, // If there was more than 1 test running the stash would be mixed and the webpack ports would already be used
